    ...
    const sections = [
      ...
      },
      {
        ...
        items: [
          ...
          ...(!isSalesView ? [{ href: '/admin/industry-analysis', label: '業種別分析', icon: 'performance' }] : []),
      ...
      },
      {
        ...
        items: [
          ...
          ...(!isSalesView ? [{ href: '/admin/requests', label: 'メッセージの管理', icon: 'request' }] : []),
        ],
      },
    ];
    return sections;
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/requests', label: 'メッセージの管理', icon: 'request' },
      ],
    },
  ];
};
