                ...
                return (
                  <tr key={p.id} className="border-b border-gray-100 hover:bg-blue-50/30 transition-colors cursor-pointer"
                    ...
                    <td className="table-cell text-center whitespace-nowrap"
                        ...
                        style={p.document_screening === 'required' ? { cursor: 'pointer' } : undefined}>
                      {p.document_screening === 'required'
                        ? <span className="text-blue-600 hover:underline font-medium">あり</span>
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg max-h-[85vh] overflow-y-auto mx-4" onClick={e => e.stopPropagation()}>
            ...
            <div className="px-6 py-4 border-t border-gray-200 flex justify-end gap-2">
              ...
              <button onClick={async () => {
                ...
                try {
                  await api.post('/api/projects/manual', { ...manualForm, call_type: 'sales' });
