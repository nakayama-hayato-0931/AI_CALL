            ...
            <table className="w-full text-xs">
              ...
              <tbody>
                ...
                <tr className="bg-blue-50/40 border-b-2 border-blue-200">
                  ...
                  <td className="py-2.5 px-3 text-right font-bold text-blue-700">{data.team.naiteiCompanies}</td>
                  ...
                  <td className="py-2.5 px-3 text-right font-bold text-blue-700">{data.team.interviewCount}</td>
                  ...
                  <td className="py-2.5 px-3 text-right font-bold text-red-600">{data.team.barashiCount}</td>
                ...
                {data.sales.map((s, i) => (
                  <tr key={s.userId} className={`border-b border-gray-50 ${i % 2 === 0 ? 'bg-white' : 'bg-gray-50/30'}`}>
                    ...
                    <td className="py-2 px-3 text-right">{s.naiteiCompanies}</td>
                    ...
                    <td className="py-2 px-3 text-right">{s.interviewCount}</td>
                    ...
                    <td className="py-2 px-3 text-right text-red-500">{s.barashiCount}</td>
