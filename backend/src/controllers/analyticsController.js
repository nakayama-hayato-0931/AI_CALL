...
const getQualityMetrics = async (req, res, next) => {
  try {
    ...
    const [rows] = await pool.query(
      `SELECT
         COUNT(*) as total,
         CAST(SUM(CASE WHEN (CASE WHEN p.status = 'LOST' THEN 'lost' WHEN p.status = 'BARASHI' THEN 'barashi' WHEN p.status IN ('NAITEI','FUGOKAKU','KEKKA_MACHI','NAITEI_TORIKESHI','HIRED','WAITING_RESULT','INTERVIEW_DONE') THEN 'iv_done' WHEN p.status = 'MENSETSU_KAKUTEI' OR (p.interview_date IS NOT NULL AND p.interview_date >= CURDATE()) THEN 'iv_set' WHEN p.status = 'SHORUI_CHU' OR (p.document_screening = 'required' AND p.status = 'BOSHUCHU') THEN 'screening' WHEN COALESCE(p.mail_replied,0) = 0 AND COALESCE(p.phone_confirmed,0) = 0 THEN 'waiting' ELSE 'other' END) = 'lost' THEN 1 ELSE 0 END) AS SIGNED) as lost,
         CAST(SUM(CASE WHEN (CASE WHEN p.status = 'LOST' THEN 'lost' WHEN p.status = 'BARASHI' THEN 'barashi' WHEN p.status IN ('NAITEI','FUGOKAKU','KEKKA_MACHI','NAITEI_TORIKESHI','HIRED','WAITING_RESULT','INTERVIEW_DONE') THEN 'iv_done' WHEN p.status = 'MENSETSU_KAKUTEI' OR (p.interview_date IS NOT NULL AND p.interview_date >= CURDATE()) THEN 'iv_set' WHEN p.status = 'SHORUI_CHU' OR (p.document_screening = 'required' AND p.status = 'BOSHUCHU') THEN 'screening' WHEN COALESCE(p.mail_replied,0) = 0 AND COALESCE(p.phone_confirmed,0) = 0 THEN 'waiting' ELSE 'other' END) = 'waiting' THEN 1 ELSE 0 END) AS SIGNED) as waiting_contact,
         CAST(SUM(CASE WHEN (CASE WHEN p.status = 'LOST' THEN 'lost' WHEN p.status = 'BARASHI' THEN 'barashi' WHEN p.status IN ('NAITEI','FUGOKAKU','KEKKA_MACHI','NAITEI_TORIKESHI','HIRED','WAITING_RESULT','INTERVIEW_DONE') THEN 'iv_done' WHEN p.status = 'MENSETSU_KAKUTEI' OR (p.interview_date IS NOT NULL AND p.interview_date >= CURDATE()) THEN 'iv_set' WHEN p.status = 'SHORUI_CHU' OR (p.document_screening = 'required' AND p.status = 'BOSHUCHU') THEN 'screening' WHEN COALESCE(p.mail_replied,0) = 0 AND COALESCE(p.phone_confirmed,0) = 0 THEN 'waiting' ELSE 'other' END) = 'screening' THEN 1 ELSE 0 END) AS SIGNED) as screening_in_progress,
         CAST(SUM(CASE WHEN (CASE WHEN p.status = 'LOST' THEN 'lost' WHEN p.status = 'BARASHI' THEN 'barashi' WHEN p.status IN ('NAITEI','FUGOKAKU','KEKKA_MACHI','NAITEI_TORIKESHI','HIRED','WAITING_RESULT','INTERVIEW_DONE') THEN 'iv_done' WHEN p.status = 'MENSETSU_KAKUTEI' OR (p.interview_date IS NOT NULL AND p.interview_date >= CURDATE()) THEN 'iv_set' WHEN p.status = 'SHORUI_CHU' OR (p.document_screening = 'required' AND p.status = 'BOSHUCHU') THEN 'screening' WHEN COALESCE(p.mail_replied,0) = 0 AND COALESCE(p.phone_confirmed,0) = 0 THEN 'waiting' ELSE 'other' END) = 'iv_set' THEN 1 ELSE 0 END) AS SIGNED) as interview_set,
         CAST(SUM(CASE WHEN (CASE WHEN p.status = 'LOST' THEN 'lost' WHEN p.status = 'BARASHI' THEN 'barashi' WHEN p.status IN ('NAITEI','FUGOKAKU','KEKKA_MACHI','NAITEI_TORIKESHI','HIRED','WAITING_RESULT','INTERVIEW_DONE') THEN 'iv_done' WHEN p.status = 'MENSETSU_KAKUTEI' OR (p.interview_date IS NOT NULL AND p.interview_date >= CURDATE()) THEN 'iv_set' WHEN p.status = 'SHORUI_CHU' OR (p.document_screening = 'required' AND p.status = 'BOSHUCHU') THEN 'screening' WHEN COALESCE(p.mail_replied,0) = 0 AND COALESCE(p.phone_confirmed,0) = 0 THEN 'waiting' ELSE 'other' END) = 'iv_done' THEN 1 ELSE 0 END) AS SIGNED) as interview_done,
         CAST(SUM(CASE WHEN (CASE WHEN p.status = 'LOST' THEN 'lost' WHEN p.status = 'BARASHI' THEN 'barashi' WHEN p.status IN ('NAITEI','FUGOKAKU','KEKKA_MACHI','NAITEI_TORIKESHI','HIRED','WAITING_RESULT','INTERVIEW_DONE') THEN 'iv_done' WHEN p.status = 'MENSETSU_KAKUTEI' OR (p.interview_date IS NOT NULL AND p.interview_date >= CURDATE()) THEN 'iv_set' WHEN p.status = 'SHORUI_CHU' OR (p.document_screening = 'required' AND p.status = 'BOSHUCHU') THEN 'screening' WHEN COALESCE(p.mail_replied,0) = 0 AND COALESCE(p.phone_confirmed,0) = 0 THEN 'waiting' ELSE 'other' END) = 'barashi' THEN 1 ELSE 0 END) AS SIGNED) as barashi,
         CAST(SUM(CASE WHEN (CASE WHEN p.status = 'LOST' THEN 'lost' WHEN p.status = 'BARASHI' THEN 'barashi' WHEN p.status IN ('NAITEI','FUGOKAKU','KEKKA_MACHI','NAITEI_TORIKESHI','HIRED','WAITING_RESULT','INTERVIEW_DONE') THEN 'iv_done' WHEN p.status = 'MENSETSU_KAKUTEI' OR (p.interview_date IS NOT NULL AND p.interview_date >= CURDATE()) THEN 'iv_set' WHEN p.status = 'SHORUI_CHU' OR (p.document_screening = 'required' AND p.status = 'BOSHUCHU') THEN 'screening' WHEN COALESCE(p.mail_replied,0) = 0 AND COALESCE(p.phone_confirmed,0) = 0 THEN 'waiting' ELSE 'other' END) = 'other' THEN 1 ELSE 0 END) AS SIGNED) as other_status
    ...
    if (qSystemFrom) {
      try {
        ...
        const adjustMap = {
          ...
          q_interview_done: { rowKey: 'interview_done', actualSql: `SELECT COUNT(*) as cnt FROM projects p WHERE p.owner_user_id = ? AND p.is_legacy = 0 AND p.is_prospect = 0 AND (CASE WHEN p.status = 'LOST' THEN 'lost' WHEN p.status = 'BARASHI' THEN 'barashi' WHEN p.status IN ('NAITEI','FUGOKAKU','KEKKA_MACHI','NAITEI_TORIKESHI','HIRED','WAITING_RESULT','INTERVIEW_DONE') THEN 'iv_done' WHEN p.status = 'MENSETSU_KAKUTEI' OR (p.interview_date IS NOT NULL AND p.interview_date >= CURDATE()) THEN 'iv_set' WHEN p.status = 'SHORUI_CHU' OR (p.document_screening = 'required' AND p.status = 'BOSHUCHU') THEN 'screening' WHEN COALESCE(p.mail_replied,0) = 0 AND COALESCE(p.phone_confirmed,0) = 0 THEN 'waiting' ELSE 'other' END) = 'iv_done' AND DATE(p.created_at) = ?${wcSql}` },
          ...
          q_other_status: { rowKey: 'other_status', actualSql: `SELECT COUNT(*) as cnt FROM projects p WHERE p.owner_user_id = ? AND p.is_legacy = 0 AND p.is_prospect = 0 AND (CASE WHEN p.status = 'LOST' THEN 'lost' WHEN p.status = 'BARASHI' THEN 'barashi' WHEN p.status IN ('NAITEI','FUGOKAKU','KEKKA_MACHI','NAITEI_TORIKESHI','HIRED','WAITING_RESULT','INTERVIEW_DONE') THEN 'iv_done' WHEN p.status = 'MENSETSU_KAKUTEI' OR (p.interview_date IS NOT NULL AND p.interview_date >= CURDATE()) THEN 'iv_set' WHEN p.status = 'SHORUI_CHU' OR (p.document_screening = 'required' AND p.status = 'BOSHUCHU') THEN 'screening' WHEN COALESCE(p.mail_replied,0) = 0 AND COALESCE(p.phone_confirmed,0) = 0 THEN 'waiting' ELSE 'other' END) = 'other' AND DATE(p.created_at) = ?${wcSql}` },
    ...
    const [rows] = await pool.query(
      `SELECT p.id, p.job_number, p.status, p.created_at, p.interview_date, p.memo,
       ...
       WHERE p.is_legacy = 0 AND p.is_prospect = 0
         AND (CASE WHEN p.status = 'LOST' THEN 'lost' WHEN p.status = 'BARASHI' THEN 'barashi' WHEN p.status IN ('NAITEI','FUGOKAKU','KEKKA_MACHI','NAITEI_TORIKESHI','HIRED','WAITING_RESULT','INTERVIEW_DONE') THEN 'iv_done' WHEN p.status = 'MENSETSU_KAKUTEI' OR (p.interview_date IS NOT NULL AND p.interview_date >= CURDATE()) THEN 'iv_set' WHEN p.status = 'SHORUI_CHU' OR (p.document_screening = 'required' AND p.status = 'BOSHUCHU') THEN 'screening' WHEN COALESCE(p.mail_replied,0) = 0 AND COALESCE(p.phone_confirmed,0) = 0 THEN 'waiting' ELSE 'other' END) = 'waiting'
...
const getScreeningInProgressDetail = async (req, res, next) => {
  try {
    ...
    const where = [
      ...
      `(CASE WHEN p.status = 'LOST' THEN 'lost' WHEN p.status = 'BARASHI' THEN 'barashi' WHEN p.status IN ('NAITEI','FUGOKAKU','KEKKA_MACHI','NAITEI_TORIKESHI','HIRED','WAITING_RESULT','INTERVIEW_DONE') THEN 'iv_done' WHEN p.status = 'MENSETSU_KAKUTEI' OR (p.interview_date IS NOT NULL AND p.interview_date >= CURDATE()) THEN 'iv_set' WHEN p.status = 'SHORUI_CHU' OR (p.document_screening = 'required' AND p.status = 'BOSHUCHU') THEN 'screening' WHEN COALESCE(p.mail_replied,0) = 0 AND COALESCE(p.phone_confirmed,0) = 0 THEN 'waiting' ELSE 'other' END) = 'screening'`,
    ];
    const params = [];
...
const getInterviewDoneDetail = async (req, res, next) => {
  try {
    ...
    const where = [
      `p.is_legacy = 0`,
      `p.is_prospect = 0`,
      `(CASE WHEN p.status = 'LOST' THEN 'lost' WHEN p.status = 'BARASHI' THEN 'barashi' WHEN p.status IN ('NAITEI','FUGOKAKU','KEKKA_MACHI','NAITEI_TORIKESHI','HIRED','WAITING_RESULT','INTERVIEW_DONE') THEN 'iv_done' WHEN p.status = 'MENSETSU_KAKUTEI' OR (p.interview_date IS NOT NULL AND p.interview_date >= CURDATE()) THEN 'iv_set' WHEN p.status = 'SHORUI_CHU' OR (p.document_screening = 'required' AND p.status = 'BOSHUCHU') THEN 'screening' WHEN COALESCE(p.mail_replied,0) = 0 AND COALESCE(p.phone_confirmed,0) = 0 THEN 'waiting' ELSE 'other' END) = 'iv_done'`,
    ];
    const params = [];
    if (date_from) { where.push(`DATE(p.created_at) >= ?`); params.push(date_from); }
    if (date_to)   { where.push(`DATE(p.created_at) <= ?`); params.push(date_to); }
