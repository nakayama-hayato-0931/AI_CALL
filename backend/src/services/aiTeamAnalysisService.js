...
- 最大3ステップの改善段階を示す
  ...
  "needs_meeting": true or false,
  "meeting_reason": "面談が必要な場合のみ理由を1文で（不要ならnull）"
}

【面談要否の判定ルール】
以下のいずれかに該当する場合、needs_meetingをtrueにしてください:
- 改善点が深刻で、OJTだけでは解決が難しいと判断される場合
- 成功事例がなく、改善事例でも基本的なスキルが不足している場合
- モチベーションや方向性に関する課題が見られる場合
- 同じ課題が繰り返し指摘されている場合
単にスコアが低いだけでは面談不要です。改善の方向性が見えない場合に面談を推奨してください。
